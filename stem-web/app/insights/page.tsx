      ...
      <section className="relative overflow-hidden px-6 py-20 sm:py-24 lg:px-8 lg:py-28">
        ...
        <div className="relative mx-auto max-w-[980px] text-center">
          ...
          <p className="mx-auto mt-6 max-w-[46ch] text-lg leading-8 text-slate-600 sm:text-xl">
            Reports, briefs, and observations designed to help fintech and financial teams and decision makers understand what is changing and why it matters.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-[1280px] gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)] lg:items-center">
          <div className="rounded-[30px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f7f9fc_100%)] p-7 shadow-[0_18px_44px_rgba(15,23,42,0.06)]">
            ...
            <h2 className="text-4xl font-bold tracking-[-0.04em] text-deep-ink sm:text-5xl">
              The state of market clarity for financial teams.
            </h2>
            <p className="mt-6 text-lg leading-8 text-slate-600">
              A practical look at how teams deal with external ambiguity, where decision friction shows up, and why better timing starts with better visibility.
            </p>
            <div className="mt-8">
          ...
          <div className="rounded-[30px] border border-slate-200 bg-[#0f172a] p-7 text-white shadow-[0_24px_64px_rgba(15,23,42,0.28)]">
        ...
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {ARTICLES.map((article) => (
              <article key={article.title} className="group rounded-[30px] border border-slate-200 bg-white p-6 shadow-[0_18px_44px_rgba(15,23,42,0.06)] transition-transform duration-300 hover:-translate-y-1">
                ...
                <Link href="#" className="mt-8 inline-flex items-center gap-2 text-sm font-medium text-primary-blue">
                  Read brief <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
                </Link>
              </article>
            ))}
          </div>
