...
export const metadata: Metadata = {
  ...
  description: "See how Stem monitors markets, tracks competitors, and surfaces the signals that matter for financial teams in Nigeria.",
  openGraph: {
    title: "Platform | Stem",
    description: "See how Stem monitors markets, tracks competitors, and surfaces the signals that matter.",
  },
};
        ...
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            {PLATFORM_POINTS.map((item) => (
              <div key={item.title} className="rounded-[28px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_100%)] p-6 shadow-[0_18px_44px_rgba(15,23,42,0.06)]">
        ...
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {OUTPUTS.map((item) => {
              ...
              return (
                <div key={item.title} className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_44px_rgba(15,23,42,0.06)]">
      ...
      <section className="bg-[#0f172a] px-6 py-20 text-white sm:py-24 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-[840px] text-center">
          <h2 className="text-4xl font-bold tracking-[-0.04em] sm:text-5xl">
            See how Stem could fit your workflow.
          </h2>
          <p className="mt-6 text-lg leading-8 text-slate-300">
            Tell us what your team needs to track, assess, or decide. We&apos;ll show you where the platform fits and where it helps first.
          </p>
