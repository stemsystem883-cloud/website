...
export const metadata: Metadata = {
  ...
  description: "How financial teams use Stem to track change, reduce guesswork, and move faster.",
  openGraph: {
  ...
  return (
    <div className="flex-1 bg-[#fbfcff]">
      ...
      <section className="bg-white px-6 py-20 sm:py-24 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-[1280px] grid gap-6 md:grid-cols-2">
          {USE_CASES.map((item) => {
            const Icon = item.icon;
            return (
              <div key={item.title} className="group rounded-[30px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_100%)] p-6 shadow-[0_18px_44px_rgba(15,23,42,0.06)] transition-transform duration-300 hover:-translate-y-1">
        ...
        <div className="mx-auto grid max-w-[1280px] gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              The best way to frame Stem is through the decisions teams already need to make. That keeps the product grounded and easier to understand.
            </p>
          </div>
      ...
      <section className="bg-[#0f172a] px-6 py-20 text-white sm:py-24 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-[840px] text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-300">
            We can map Stem to the market questions, workflows, and decision pressure your team is already dealing with.
          </p>
