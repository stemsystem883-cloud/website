...
const FAQS = [
  {
    question: "What is Stem-Cogent (a product of Stem Systems Ltd) and how does it help fintechs?",
    answer: "Stem-Cogent (a product of Stem Systems Ltd) is Stem's proprietary market intelligence framework. It helps fintechs by filtering scattered market signals into a structured grid of competitor moves, regulatory shifts, and expansion opportunities, allowing teams to act with more confidence.",
  },
  {
  ...
  {
    question: "Who are the primary users of Stem-Cogent (a product of Stem Systems Ltd)?",
    answer: "Stem-Cogent (a product of Stem Systems Ltd) is built for strategy leads, growth and expansion leads, founders, CEOs, and research analysts at fintech startups and financial institutions who need to make data-driven decisions.",
  },
  {
    question: "How can Stem-Cogent (a product of Stem Systems Ltd) identify early market shifts in African fintech?",
    answer: "By monitoring a wide array of high-fidelity signals—from regulatory hints to competitor pricing changes—Stem-Cogent (a product of Stem Systems Ltd) spots patterns early, giving your team the visibility needed to lead rather than react.",
  },
  {
  ...
  {
    question: "Is Stem-Cogent (a product of Stem Systems Ltd) a standalone platform or does it integrate with existing tools?",
  ...
  {
    question: "How does Stem-Cogent (a product of Stem Systems Ltd) ensure data accuracy in the Nigerian financial sector?",
  ...
  {
    question: "How does Stem-Cogent (a product of Stem Systems Ltd) protect sensitive organizational data?",
      ...
      <div className="mx-auto max-w-[1280px]">
        <div className="max-w-3xl mb-12">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600">
            Everything you need to know about Stem, Stem-Cogent (a product of Stem Systems Ltd), and our approach to business intelligence in Nigeria.
          </p>
        </div>
